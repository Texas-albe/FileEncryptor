...
// smelibs 提供的 Qt6 静态插件：
//   platforms/ : qwindows.lib / qdirect2d.lib / qminimal.lib / qoffscreen.lib
//   imageformats/ : qjpeg.lib / qgif.lib / qico.lib
//   styles/ : qmodernwindowsstyle.lib
// 平台抽象层：Windows 用 QWindowsIntegrationPlugin（其他平台为 QMinimalIntegrationPlugin 等）。
// 图像格式：本项目主要加载 ICO（窗口图标），附带 JPEG/GIF 以支持常见图标资源。
#include <QtPlugin>
#ifdef Q_OS_WIN
